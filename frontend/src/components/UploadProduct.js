...
const UploadProduct = ({
  ...
  const handleUploadProduct = async(e) => {
    ...
    if (uploadImageCloudinary.error) {
      const errorMsg = typeof uploadImageCloudinary.error === 'string' 
        ? uploadImageCloudinary.error 
        : 'Unknown upload error'
      toast.error(`Image upload failed: ${errorMsg}`)
      return
    }

    const imageUrl = uploadImageCloudinary?.url || uploadImageCloudinary?.secure_url || ''
