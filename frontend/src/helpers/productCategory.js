const productCategory = [
    ...
    { id : 13, label : "Amplifiers", value : "amplifiers"},
    { id : 14, label : "Towers", value : "towers"},
    { id : 15, label : "Induction", value : "induction"},
    { id : 16, label : "Fan's", value : "fans"},
    { id : 17, label : "Stablizer", value : "stablizer"},
]
